...
public class StatisticsHandler {
    ...
    private static final AtomicInteger uniqueIpCount = new AtomicInteger(); // 唯一IP请求的数量 uv
    private static final AtomicInteger count = new AtomicInteger(); // 请求总数   pv
    ...
    public static AtomicInteger getUniqueIpCount() {
