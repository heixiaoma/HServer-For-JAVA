...
import net.hserver.plugins.maven.tools.tool.ArtifactsLibraries;
import net.hserver.plugins.maven.tools.tool.Libraries;
...
public class HServerPackagerMojo extends AbstractMojo {
