package net.hserver.plugin.mybatis.hook;

import io.netty.util.concurrent.FastThreadLocal;
import net.hserver.plugin.mybatis.proxy.MybatisProxy;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import net.hserver.core.interfaces.HookAdapter;
import net.hserver.core.ioc.annotation.Hook;
import net.hserver.plugin.mybatis.annotation.Tx;
