package net.hserver.plugin.mybatis;

import net.hserver.plugin.mybatis.annotation.Mybatis;
import net.hserver.plugin.mybatis.proxy.MybatisProxy;
import org.apache.ibatis.session.SqlSessionFactory;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import net.hserver.core.interfaces.PluginAdapter;
import net.hserver.core.ioc.IocUtil;
import net.hserver.core.ioc.annotation.Autowired;
import net.hserver.core.server.util.ExceptionUtil;
import net.hserver.plugin.mybatis.bean.MybatisConfig;
